"""
Django settings for falling_glitter_40709 project.
...
ROOT_URLCONF = 'falling_glitter_40709.urls'
...
WSGI_APPLICATION = 'falling_glitter_40709.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_glitter_40709 API",
    "DESCRIPTION": "API documentation for falling_glitter_40709 App",
    "VERSION": "v1",
}
