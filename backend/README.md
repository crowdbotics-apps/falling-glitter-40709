...
## Project Structure
    ...
    ├── falling_glitter_40709  # Django project configurations
...
1. Clone this repo and `cd falling_glitter_40709`
...
2. Clone this repo and `cd falling_glitter_40709`
